...
/*
	Challenge: convert the class fields and arrow methods to make use of the class `constructor` method.
 
 		1. Add a constructor() method
 		2. Call super()
 		3. Initialize your state inside the constructor
 		4. Convert your arrow function class methods back to regular class methods
